...
public class DisciplinaController {
    ...
    /**
     * Método construtor da classe DisciplinaController é aproveitada para carregar o
    ...
    /**
     * Método principal que faz a inicialização do programa para cadastro, consulta e exclusão de disciplinas.
     */
    public void inicializaPrograma() {
        // Frame
        this.frame = getjFrame();
        // Panel
        JPanel btnPnl = getjPanel();
        // Table e Scroll
        JTable table = getjTable();
        JScrollPane tabelaComScroll = new JScrollPane(table, JScrollPane.VERTICAL_SCROLLBAR_AS_NEEDED, JScrollPane.HORIZONTAL_SCROLLBAR_AS_NEEDED);
        // Adicionando componentes ao Frame.
        frame.add(table.getTableHeader(), BorderLayout.NORTH);
        frame.add(tabelaComScroll, BorderLayout.CENTER);
    ...
    private List<JButton> criarBotoes() {
        ...
        // Incluir
        JButton incluirDisciplina = new JButton("Incluir Disciplina");
    ...
    private JTable getjTable() {
        String data[][] = {{"Matemática", "60", "Matemática", "30", "Noturno"},
                ...
                {"Matemática", "60", "Matemática", "30", "Noturno"},
                {"Matemática", "60", "Matemática", "30", "Noturno"}};
        String column[] = {"Nome Disciplina", "Carga Horária", "Curso Pertence", "Número Vagas", "Período"};
